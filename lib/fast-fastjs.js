...
})(this, function(__WEBPACK_EXTERNAL_MODULE__3__, __WEBPACK_EXTERNAL_MODULE__7__, __WEBPACK_EXTERNAL_MODULE__13__) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.local().where('sync', '=', false).andWhere('draft', '=', false).andWhere('syncError', '=', false).andWhere('user_email', '=', _Auth2.default.email()).orderBy('created', 'desc', 'date').get();
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _context3.next = 9;
                return _this3.remote().select(cols).get();
              ...
              case 12:
                _context3.next = 14;
                return _this3.merged().select(cols).get();
...
var _Submission = __webpack_require__(8);
...
var _FluentConnector3 = __webpack_require__(39);

var _FluentConnector4 = _interopRequireDefault(_FluentConnector3);

var _FluentConnector5 = __webpack_require__(40);
              ...
              if (!forceOnline) {
                _fastFluent.Fluent.config({
                  ...
                  MERGE_CONNECTORS: [{
                    default: true,
                    name: 'formioLoki',
                    connector: _FluentConnector6.default
                  }]
                });
