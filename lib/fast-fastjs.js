...
var Fluent = (0, _it2.default)({
  ...
  methods: {
    ...
    getFormioBaseUrl: function getFormioBaseUrl() {
      var _config$get = _config2.default.get(),
          FLUENT_FORMIO_BASEURL = _config$get.FLUENT_FORMIO_BASEURL;

      return FLUENT_FORMIO_BASEURL;
    },
    getFastConfigUrl: function getFastConfigUrl() {
      var _config$get2 = _config2.default.get(),
          FAST_CONFIG_URL = _config$get2.FAST_CONFIG_URL;

      return FAST_CONFIG_URL;
    },
    getFastConfigId: function getFastConfigId() {
      var _config$get3 = _config2.default.get(),
          FAST_CONFIG_ID = _config$get3.FAST_CONFIG_ID;

      return FAST_CONFIG_ID;
    },
    getOfflineStart: function getOfflineStart() {
      var _config$get4 = _config2.default.get(),
          OFFLINE_START = _config$get4.OFFLINE_START;

      return OFFLINE_START;
    },
    getConfigRemoteConnector: function getConfigRemoteConnector() {
      if (window && window._FLUENT_ && window._FLUENT_.config && window._FLUENT_.config.FLUENT_REMOTE_CONNECTOR) {
        return window._FLUENT_.config.FLUENT_REMOTE_CONNECTOR;
      }
      if (global && global._FLUENT_ && global._FLUENT_.config && global._FLUENT_.config.FLUENT_REMOTE_CONNECTOR) {
        return global._FLUENT_.config.FLUENT_REMOTE_CONNECTOR;
      }
      return this.defaultRemote;
    },
    getConfigLocalConnector: function getConfigLocalConnector() {
      if (window && window._FLUENT_ && window._FLUENT_.config && window._FLUENT_.config.FLUENT_LOCAL_CONNECTOR) {
        return window._FLUENT_.config.FLUENT_LOCAL_CONNECTOR;
      }
      if (global && global._FLUENT_ && global._FLUENT_.config && global._FLUENT_.config.FLUENT_LOCAL_CONNECTOR) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(21), __webpack_require__(33)))
...
var _Fluent = __webpack_require__(1);
...
exports.default = _Fluent2.default.extend(_Model2.default, {
  properties: {
    name: 'Configuration',
    remoteConnection: {
      baseUrl: _Fluent2.default.getFastConfigUrl() || 'https://ydvahgxgqliaeuf.form.io/',
      path: 'configuration',
      id: _Fluent2.default.getFastConfigId(),
      token: null
    }
  },
  methods: {
...
exports.default = _Fluent2.default.extend(_Model2.default, {
  properties: {
    name: 'Form',
    remoteConnection: {
      baseUrl: _Fluent2.default.getFormioBaseUrl() || 'https://myFluentBaseUrl.com/',
      path: 'form',
      pullForm: true
    }
  },
...
exports.Utilities = exports.Sync = exports.Hash = exports.Role = exports.OfflinePlugin = exports.User = exports.Import = exports.Translation = exports.Configuration = exports.ParallelSurvey = exports.Submission = exports.Pages = exports.Form = exports.Auth = exports.Connection = exports.FAST = exports.Event = exports.Moment = exports.countryList = exports.Fluent = undefined;
...
var config = function () {
  ...
  function set(_ref) {
    var _ref$FLUENT_FORMIO_BA = _ref.FLUENT_FORMIO_BASEURL,
        FLUENT_FORMIO_BASEURL = _ref$FLUENT_FORMIO_BA === undefined ? undefined : _ref$FLUENT_FORMIO_BA,
        _ref$FAST_CONFIG_ID = _ref.FAST_CONFIG_ID,
        FAST_CONFIG_ID = _ref$FAST_CONFIG_ID === undefined ? undefined : _ref$FAST_CONFIG_ID,
        _ref$FAST_CONFIG_URL = _ref.FAST_CONFIG_URL,
        FAST_CONFIG_URL = _ref$FAST_CONFIG_URL === undefined ? undefined : _ref$FAST_CONFIG_URL,
        _ref$OFFLINE_START = _ref.OFFLINE_START,
        OFFLINE_START = _ref$OFFLINE_START === undefined ? undefined : _ref$OFFLINE_START;
