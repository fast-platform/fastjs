        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return _this5.local().limit(999999).get();
...
!function (e, t) {
  "object" == ( false ? undefined : _typeof(exports)) && "object" == ( false ? undefined : _typeof(module)) ? module.exports = t(__webpack_require__(9), __webpack_require__(5)) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(9), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
  ...
  return function (e) {
        ...
        var t = e.apply(this, arguments);return new Promise(function (e, r) {
    ...
    }t.default = s.Interface.compose({ methods: { getToken: function getToken() {
          return localStorage.getItem("formioToken");
        }, baseUrl: function baseUrl() {
          var e = this.connector,
              t = e.baseUrl,
              r = e.name;if (!t) throw new Error('You did not provide a baseUrl for the "' + r + '" connector');return t.replace(/\/+$/, "");
        }, get: function get() {
          var e = this;return l(regeneratorRuntime.mark(function t() {
            var r, n, a, u;return regeneratorRuntime.wrap(function (t) {
              for (;;) {
                switch (t.prev = t.next) {case 0:
                    return e.ownerEmail && e.andWhere("owner", "=", e.ownerEmail), r = void 0, n = void 0, t.next = 5, (0, i.default)(e.httpGET());case 5:
                    if (a = t.sent, u = o(a, 2), r = u[0], n = u[1], !r) {
                      t.next = 12;break;
                    }throw console.log(r), new Error("Error while getting submissions");case 12:
                    return n = e.jsApplySelect(n.data), n = e.jsApplyOrderBy(n), t.abrupt("return", n);case 15:case "end":
                    return t.stop();}
              }
            }, t, e);
          }))();
          ...
          var e = this;return l(regeneratorRuntime.mark(function t() {
            return regeneratorRuntime.wrap(function (t) {
              for (;;) {
                switch (t.prev = t.next) {case 0:
                    return t.abrupt("return", e.get());case 1:case "end":
                    return t.stop();}
              }
            }, t, e);
          }))();
        }, insert: function insert(e, t) {
          var r = this;return l(regeneratorRuntime.mark(function n() {
            var a, u, s, c;return regeneratorRuntime.wrap(function (n) {
              for (;;) {
                switch (n.prev = n.next) {case 0:
                    if (!Array.isArray(e)) {
                      n.next = 2;break;
                    }return n.abrupt("return", r.ArrayInsert(e, t));case 2:
                    return n.next = 4, (0, i.default)(r.httpPOST(e));case 4:
                    if (a = n.sent, u = o(a, 2), s = u[0], c = u[1], !s) {
                      n.next = 11;break;
                    }throw console.log(s), new Error("Cannot insert data");case 11:
                    return n.abrupt("return", c.data);case 12:case "end":
                    return n.stop();}
              }
            }, n, r);
          }))();
        }, update: function update(e) {
          var t = this;return l(regeneratorRuntime.mark(function r() {
            var n, a, u, s;return regeneratorRuntime.wrap(function (r) {
              for (;;) {
                switch (r.prev = r.next) {case 0:
                    if (e._id) {
                      r.next = 2;break;
                    }throw new Error("Formio connector error. Cannot update a Model without _id key");case 2:
                    if (!e._id.includes("_local")) {
                      r.next = 4;break;
                    }throw new Error("Formio connector error. Cannot update a local document");case 4:
                    return r.next = 6, (0, i.default)(t.httpPUT(e));case 6:
                    if (n = r.sent, a = o(n, 2), u = a[0], s = a[1], !u) {
                      r.next = 13;break;
                    }throw console.log(u), new Error("Cannot insert data");case 13:
                    return r.abrupt("return", s.data);case 14:case "end":
                    return r.stop();}
              }
            }, r, t);
          }))();
          ...
          var e = this;return l(regeneratorRuntime.mark(function t() {
            var r,
                ...
                s,
                c,
                f = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).sure;return regeneratorRuntime.wrap(function (t) {
              for (;;) {
                switch (t.prev = t.next) {case 0:
                    if (f && !0 === f) {
                      t.next = 2;break;
                    }throw new Error('Clear() method will delete everything!, you must set the "sure" parameter "clear({sure:true})" to continue');case 2:
                    return r = [], t.next = 5, (0, i.default)(e.select("_id").pluck("_id"));case 5:
                    if (n = t.sent, a = o(n, 2), s = a[0], c = a[1], !s) {
                      t.next = 12;break;
                    }throw console.log(s), new Error("Cannot get remote Model");case 12:
                    return c.forEach(function (t) {
                      r.push(e.httpDelete(t));
                    }), t.abrupt("return", u.default.all(r));case 14:case "end":
                    return t.stop();}
              }
            }, t, e);
          }))();
          ...
          var t = this;return l(regeneratorRuntime.mark(function r() {
            var n, a, u, s;return regeneratorRuntime.wrap(function (r) {
              for (;;) {
                switch (r.prev = r.next) {case 0:
                    return r.next = 2, (0, i.default)(t.httpDelete(e));case 2:
                    if (n = r.sent, a = o(n, 2), u = a[0], s = a[1], !u) {
                      r.next = 9;break;
                    }throw console.log(u), new Error("FormioConnector: Could not delete " + e);case 9:
                    return r.abrupt("return", s);case 10:case "end":
                    return r.stop();}
              }
            }, r, t);
          }))();
          ...
          var t = this;return l(regeneratorRuntime.mark(function r() {
            var a, u, s, c;return regeneratorRuntime.wrap(function (r) {
              for (;;) {
                switch (r.prev = r.next) {case 0:
                    if ("string" == typeof e) {
                      r.next = 2;break;
                    }throw new Error('Formio connector find() method only accepts strings "' + (void 0 === e ? "undefined" : n(e)) + '" given "' + e + '"');case 2:
                    return r.next = 4, (0, i.default)(t.where("_id", "=", e).first());case 4:
                    if (a = r.sent, u = o(a, 2), s = u[0], c = u[1], !s) {
                      r.next = 11;break;
                    }throw console.log(s), new Error("Find() could not get remote data");case 11:
                    return r.abrupt("return", c);case 12:case "end":
                    return r.stop();}
              }
            }, r, t);
          }))();
          ...
          var e = this,
              t = this && this.baseUrl() ? this.baseUrl() : void 0,
              r = a.default.get(function () {
            return e.remoteConnection.path;
          }, void 0),
              n = a.default.get(function () {
            return e.remoteConnection.id;
          }, void 0);if (!a.default.get(function () {
            return e.remoteConnection.pullForm;
          }, void 0) && r && (r = n ? r + "/submission/" + n : r + "/submission"), !t) throw new Error("Cannot get remote model. baseUrl not defined");return r ? t + "/" + r : t;
        }, getHeaders: function getHeaders() {
          var e = {},
              t = localStorage.getItem("formioToken");return (this.remoteConnection.token || "" === this.remoteConnection.token) && (t = this.remoteConnection.token), t ? (e[this.getTokenType(t)] = t, e) : e;
        }, getSpacer: function getSpacer(e) {
          ...
          var e = this.getUrl(),
              ...
              n = this.getLimit(),
              o = this.getSkip(),
              i = this.getSelect();if (e = e + "" + n, e = r ? e + this.getSpacer(e) + r : e, e = o ? e + this.getSpacer(e) + o : e, e = i ? e + this.getSpacer(e) + i : e, !c.default.isOnline()) throw new Error("Cannot make get request to " + e + ".You are not online");return u.default.get(e, { headers: t });
        }, httpPOST: function httpPOST(e) {
          var t = this.getUrl(),
              r = this.getHeaders();if (!c.default.isOnline()) throw new Error("Cannot make request post to " + t + ".You are not online");return u.default.post(t, e, { headers: r });
        }, httpPUT: function httpPUT(e) {
          var t = this.getUrl() + "/" + e._id,
              r = this.getHeaders();if (!c.default.isOnline()) throw new Error("Cannot make request post to " + t + ".You are not online");return u.default.put(t, e, { headers: r });
        }, httpDelete: function httpDelete(e) {
          var t = this.getHeaders(),
              r = this.getUrl() + "/" + e;return u.default.delete(r, { headers: t });
        }, getTokenType: function getTokenType(e) {
          return e.length > 32 ? "x-jwt-token" : "x-token";
        }, getFilters: function getFilters() {
          var e = this.whereArray;if (e && 0 !== e.length) {
            var t = "";return e.forEach(function (e) {
              var r = "",
                  ...
                  i = e[2];switch (o) {case "=":
                  t = t + n + "=" + i + "&";break;case "!=":
                  t = t + n + "__ne=" + i + "&";break;case ">":
                  t = t + n + "__gt=" + i + "&";break;case ">=":
                  t = t + n + "__gte=" + i + "&";break;case "<":
                  t = t + n + "__lt=" + i + "&";break;case "<=":
                  t = t + n + "__lte=" + i + "&";break;case "in":
                  r = "", i.forEach(function (e, t, n) {
                    r = t === n.length - 1 ? r + e : r + e + ",";
                  }), t = t + n + "__in=" + r + "&";break;case "nin":
                  r = "", i.forEach(function (e, t, n) {
                    r = t === n.length - 1 ? r + e : r + e + ",";
                  }), t = t + n + "__nin=" + r + "&";break;case "exists":
                  t = t + n + "__exists=" + !0 + "&";break;case "!exists":
                  t = t + n + "__exists=" + !1 + "&";break;case "regex":
                  t = t + n + "__regex=" + i + "&";}
            }), t.substring(0, t.length - 1);
          }
        }, getLimit: function getLimit() {
          return this.limitNumber && 0 !== this.limitNumber || (this.limitNumber = 50), "?limit=" + this.limitNumber;
        }, getSkip: function getSkip() {
          return this.offsetNumber || (this.offsetNumber = 0), "skip=" + this.offsetNumber;
        }, getSelect: function getSelect() {
          var e = this.selectArray;if (e = e.map(function (e) {
            return e.split(" as ")[0];
          })) return "select=" + e.join(",");
        } } });
  }, function (e, t, r) {
    "use strict";
    function n(e, t) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });var n = Object.assign || function (e) {
      ...
      var e = function e(_e, t) {
        ...
        var o = r;r.includes(" as ") && (o = (r = r.split(" as "))[0]);var i = e(function () {
          ...
          return !(e && void 0 === (_t = _t[e]));
        }) ? _t : n;return { label: i || o, value: a };
      },
          r = function e(t, r, o, i, a) {
        t && (i = i || "", t.forEach(function (t) {
          if (t) {
            var u = t.columns && Array.isArray(t.columns),
                s = t.rows && Array.isArray(t.rows),
                c = t.components && Array.isArray(t.components),
                f = !1,
                l = t.key ? i ? i + "." + t.key : t.key : "";a && (t.parent = n({}, a), delete t.parent.components, delete t.parent.componentMap, delete t.parent.columns, delete t.parent.rows), (o || t.tree || !u && !s && !c) && (f = r(t, l));var d = function d() {
              return t.key && !["panel", "table", "well", "columns", "fieldset", "tabs", "form"].includes(t.type) && (["datagrid", "container", "editgrid"].includes(t.type) || t.tree) ? l : t.key && "form" === t.type ? l + ".data" : i;
            };f || (u ? t.columns.forEach(function (n) {
              return e(n.components, r, o, d(), a ? t : null);
            }) : s ? t.rows.forEach(function (n) {
              Array.isArray(n) && n.forEach(function (n) {
                return e(n.components, r, o, d(), a ? t : null);
              });
            }) : c && e(t.components, r, o, d(), a ? t : null));
          }
        }));
      };return Object.freeze({ cloneDeep: function cloneDeep(e) {
          return JSON.parse(JSON.stringify(e));
        }, get: e, orderBy: function orderBy() {}, isEmpty: function isEmpty(e) {
          if (!e) return !0;if (Array.isArray(e) || "string" == typeof e) return !e.length;for (var t in e) {
            if (hasOwnProperty.call(e, t)) return !1;
          }return !0;
        }, debounce: function debounce(e, t) {
          var r = void 0;return function () {
            var n = this,
                o = arguments;clearTimeout(r), r = setTimeout(function () {
              return e.apply(n, o);
            }, t);
          };
        }, getFromPath: t, deleteNulls: function e(t) {
          var r = t,
              n = r instanceof Array;for (var i in r) {
            null === r[i] ? n ? r.splice(i, 1) : delete r[i] : "object" === o(r[i]) && e(r[i]);
          }return r;
        }, eachComponent: r, findComponents: function findComponents(e, n) {
          var o = [];return r(e, function (e, r) {
            (function (e, r) {
              if ("string" == typeof r) return e.key === r;var n = !1;return Object.keys(r).forEach(function (o) {
                if (!(n = t(e, o).value === r[o])) return !1;
              }), n;
            })(e, n) && (e.path = r, o.push(e));
          }, !0), o;
        }, unixDate: function unixDate() {
    ...
    e.exports = function (e) {
      ...
      var n = r(2),
        ...
        var e = l.apply([], arguments).filter(s);return 0 === e.length ? void 0 : e;
      }function p(e) {
        if (!u(e)) return e;var t = e.methods,
            r = e.properties,
            n = e.props,
            o = e.initializers,
            i = e.init,
            ...
            m = e.staticProperties,
            v = e.statics,
            g = e.staticDeepProperties,
            y = e.deepStatics,
            w = e.configuration,
            b = e.conf,
            E = e.deepConfiguration,
            _ = e.deepConf,
            x = u(n) || u(r) ? f({}, n, r) : void 0,
            A = u(p) ? c({}, p) : void 0;A = u(l) ? c(A, l) : A;var O = u(v) || u(m) ? f({}, v, m) : void 0,
            P = u(y) ? c({}, y) : void 0;P = u(g) ? c(P, g) : P;var k = e.staticPropertyDescriptors;a(e.name) && (k = f({}, k || {}, { name: { value: e.name } }));var C = u(b) || u(w) ? f({}, b, w) : void 0,
            j = u(_) ? c({}, _) : void 0;j = u(E) ? c(j, E) : j;var F = d(i, o),
            S = d(s),
            N = {};return t && (N.methods = t), x && (N.properties = x), F && (N.initializers = F), S && (N.composers = S), A && (N.deepProperties = A), O && (N.staticProperties = O), P && (N.staticDeepProperties = P), h && (N.propertyDescriptors = h), k && (N.staticPropertyDescriptors = k), C && (N.configuration = C), j && (N.deepConfiguration = j), N;
      }function h() {
        "use strict";
        for (var e = arguments.length, t = [], r = 0; r < e; r += 1) {
          var o = arguments[r];t.push(i(o) ? o : p(o));
        }return n.apply(this || m, t);
      }var m = o.compose({ staticProperties: { create: function create() {
            return this.apply(this, arguments);
          }, compose: h } }),
          v = o.compose.staticProperties;for (var g in v) {
        h[g] = v[g].bind(m);
      ...
      var n = r(5),
        ...
        var r = function e(t) {
          var r = e.compose || {},
              n = { __proto__: r.methods };if (c(n, r.deepProperties), s(n, r.properties), Object.defineProperties(n, r.propertyDescriptors || {}), !r.initializers || 0 === r.initializers.length) return n;void 0 === t && (t = {});for (var i = r.initializers, a = i.length, u = 0; u < a; u += 1) {
            var l = i[u];if (o(l)) {
              var d = l.call(n, t, { instance: n, stamp: e, args: f.apply(arguments) });n = void 0 === d ? n : d;
            }
          }return n;
        };e.staticDeepProperties && c(r, e.staticDeepProperties), e.staticProperties && s(r, e.staticProperties), e.staticPropertyDescriptors && Object.defineProperties(r, e.staticPropertyDescriptors);var n = o(r.compose) ? r.compose : t;return s(r.compose = function () {
          "use strict";
        ...
        if (n(t)) {
          var i = t.length,
              a = e[r] || [];e[r] = a;for (var u = 0; u < i; u += 1) {
            var s = t[u];o(s) && a.indexOf(s) < 0 && a.push(s);
          }
        }
      }function p(e, t, r, n) {
        ...
        var r = t && t.compose || t;m(e, r, "methods"), m(e, r, "properties"), h(e, r, "deepProperties"), m(e, r, "propertyDescriptors"), m(e, r, "staticProperties"), h(e, r, "staticDeepProperties"), m(e, r, "staticPropertyDescriptors"), m(e, r, "configuration"), h(e, r, "deepConfiguration"), d(e, r.initializers, "initializers"), d(e, r.composers, "composers");
      }e.exports = function e() {
        "use strict";
        var t = {},
            r = [];u(this) && (v(t, this), r.push(this));for (var o = 0; o < arguments.length; o++) {
          var i = arguments[o];u(i) && (v(t, i), r.push(i));
        }var s = l(t, e),
            c = t.composers;if (n(c) && c.length > 0) for (var f = 0; f < c.length; f += 1) {
          var d = (0, c[f])({ stamp: s, composables: r });s = a(d) ? d : s;
        }return s;
      };
    }, function (e, t) {
      e.exports = function (e) {
      ...
      var n = r(15),
        ...
        if (void 0 === t) return e;if (i(t)) return (i(e) ? e : []).concat(t);if (!n(t)) return t;for (var r = o(e) ? e : {}, u = Object.keys(t), s = 0; s < u.length; s += 1) {
          var c = u[s],
              f = t[c];if (void 0 !== f) {
            var l = r[c],
                d = n(l) || i(f) ? l : {};r[c] = a(d, f);
          }
        }return r;
      }e.exports = function (e) {
        for (var t = 1; t < arguments.length; t++) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 });var n = i(r(0)),
          ...
          return e && e.__esModule ? e : { default: e };
              ...
              var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                  ...
                  a = i && i.connectors && i.connectors.remote;if (!a) throw new Error("No remote connector was defined. Please define it using Fluent.config()");var u = this.getConnector(a, "remote");if (this.config.remote.token = r || this.config.remote.token, o && (this.config.remote.pullForm = o || this.config.remote.pullForm), u) return u.connector({ remoteConnection: this.config.remote, connector: u });throw new Error("No default remote connector found. Please assign one as your default in Fluent.config");
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });var n = Object.assign || function (e) {
        ...
        if (Array.isArray(e)) {
          ...
          if (!Array.isArray(e)) throw new Error("Collect method only accepts arrays of data");this.data = e;
            ...
            for (var t = [].concat(u(this.data)), r = []; t.length;) {
              r.push(t.splice(0, e));
            }return this.data = r, this;
          }, collapse: function collapse() {
            var e = [];return [].concat(u(this.data)).forEach(function (t) {
            ...
            var t = void 0;return [].concat(u(this.data)).forEach(function (r, o) {
              r instanceof Object ? (t || (t = []), t[o] = n({}, r, { _value: e[o] })) : (t || (t = {}), t[r] = e[o]);
            }), this.data = t, this;
          }, concat: function concat(e) {
            return this.data = [].concat(u(this.data), u(e)), this;
          }, contains: function contains() {
            var e = void 0,
                t = void 0,
                r = void 0;return 1 === arguments.length ? (this.isFunction(arguments.length <= 0 ? void 0 : arguments[0]) && (r = arguments.length <= 0 ? void 0 : arguments[0]), e = arguments.length <= 0 ? void 0 : arguments[0]) : (e = arguments.length <= 1 ? void 0 : arguments[1], t = arguments.length <= 0 ? void 0 : arguments[0]), [].concat(u(this.data)).some(function (n, o) {
              if (r) return !!r(n, o);var a = n;if (n instanceof Object) {
                var u = i.default.getFromPath(n, t, void 0);u.value && (a = u.value);
              }return a === e;
            });
      ...
      (function (e) {
        ...
        }var s = (0, n.default)({ init: function init() {
            this.registerGlobalVariable();
          }, properties: {}, methods: { model: function model() {
              for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) {
                t[r] = arguments[r];
              }return this.registerModel(t), o.default.compose.apply(o.default, u(t));
              ...
              var r = t.REMOTE_CONNECTORS,
                  ...
                  u = void 0 === a ? void 0 : a;"undefined" != typeof window && window && (window._FLUENT_.connectors = { local: i, remote: n, merge: u }), void 0 !== e && e && (e._FLUENT_.connectors = { local: i, remote: n, merge: u });
      ...
      var n = r(2);function o(e) {
        return function (t) {
          ...
          u = o("configuration"),
          s = o("deepProperties"),
          c = o("staticDeepProperties"),
          f = o("deepConfiguration"),
          l = o("initializers");e.exports = n({ staticProperties: { methods: o("methods"), props: i, properties: i, statics: a, staticProperties: a, conf: u, configuration: u, deepProps: s, deepProperties: s, deepStatics: c, staticDeepProperties: c, deepConf: f, deepConfiguration: f, init: l, initializers: l, composers: o("composers"), propertyDescriptors: o("propertyDescriptors"), staticPropertyDescriptors: o("staticPropertyDescriptors") } });
    }, function (e, t) {
      e.exports = function (e) {
      ...
      var n = r(2),
        ...
        var r = t.stamp.compose,
            ...
            a = {};o.set(a, this);var u = r.methods;if (!u) return a;for (var s = Object.keys(u), c = 0; c < s.length; c++) {
          var f = s[c];n.indexOf(f) < 0 && (a[f] = i(u[f], f));
        }if ("undefined" != typeof Symbol) {
          var l = Symbol.for("stamp");u[l] && (a[l] = t.stamp);
        }return a;
      }var u = n({ initializers: [a], deepConfiguration: { Privatize: { methods: [] } }, staticProperties: { privatizeMethods: function privatizeMethods() {
            "use strict";
            for (var e = [], t = 0; t < arguments.length; t++) {
              var r = arguments[t];"string" == typeof r && r.length > 0 && e.push(r);
            }return (this && this.compose ? this : u).compose({ deepConfiguration: { Privatize: { methods: e } } });
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });var n = a(r(0)),
        ...
        return function () {
          ...
          var t = e.name,
            ...
            var e = this;return s(regeneratorRuntime.mark(function t() {
            ...
            var t = this,
                r = Array.isArray(e) ? [].concat(u(e)) : [e];return this.selectArray.length > 0 && (r = r.map(function (e) {
            ...
            var t = this;return s(regeneratorRuntime.mark(function r() {
            ...
            var t = [].concat(u(e));if (0 === this.orderByArray.length) return t;var r = this.orderByArray[0];if (this.selectArray.length > 0 && (r.includes(".") || r.includes("["))) throw new Error('Cannot orderBy nested attribute "' + r + '" when using Select. You must rename the attribute');var n = this.orderByArray[1],
                i = this.orderByArray[2];return i || (i = "string"), t = t.sort(function (e, t) {
              var a = o.default.getFromPath(e, r, void 0).value,
                  u = o.default.getFromPath(t, r, void 0).value;if (void 0 === a || void 0 === u) throw new Error('Cannot order by property "' + r + '" not all values have this property');return i.includes("string") || i.includes("number") ? "asc" === n ? a > u ? 1 : a < u ? -1 : 0 : a > u ? -1 : a < u ? 1 : 0 : i.includes("date") ? "asc" === n ? new Date(a) - new Date(u) : new Date(u) - new Date(a) : void 0;
            });
            ...
            var r = this;return s(regeneratorRuntime.mark(function n() {
              var o, i, a, u, s, c, f, l;return regeneratorRuntime.wrap(function (n) {
                for (;;) {
                  switch (n.prev = n.next) {case 0:
                      o = 1, i = e.length, a = !0, u = !1, s = void 0, n.prev = 5, c = e[Symbol.iterator]();case 7:
                      if (a = (f = c.next()).done) {
                        n.next = 26;break;
                      ...
                      n.prev = 28, n.t1 = n.catch(5), u = !0, s = n.t1;case 32:
                      n.prev = 32, n.prev = 33, !a && c.return && c.return();case 35:
                      if (n.prev = 35, !u) {
                        n.next = 38;break;
                      }throw s;case 38:
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });var n = a(r(7)),
        o = a(r(8)),
        i = a(r(0));function a(e) {
      return e && e.__esModule ? e : { default: e };
    }var u = function () {
      var e = "undefined" == typeof window || !window || !window.navigator || window.navigator.onLine;return Object.freeze({ isOnline: function isOnline() {
          return new o.default(function (e, t) {
            i.default.get("https://yesno.wtf/api").then(function (t) {
              e(!0);
            }).catch(function (t) {
              e(!1);
            });
          ...
          n.default.listen({ name: "online", callback: function callback() {
              console.log("App is now online"), e || (e = !0, n.default.emit({ name: "FAST:CONNECTION:ONLINE", data: e, text: "Application is now online" }));
            } }), n.default.listen({ name: "offline", callback: function callback() {
              console.log("App is now offline"), e && (e = !1, n.default.emit({ name: "FAST:CONNECTION:OFFLINE", data: e, text: "Application is now offline" }));
            } });
        } });
    }();t.default = u;
  }, function (e, t, r) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });var n = function () {
      var e = function e(_e3, t) {
        var r = document.createEvent("CustomEvent");return t = t || { bubbles: !1, cancelable: !1, detail: void 0 }, r.initCustomEvent(_e3, t.bubbles, t.cancelable, t.detail), r;
...
var ParallelSurvey = function () {
  ...
  */
  ...
  function prepareNewGroupObject(_ref3) {
    ...
    vm.currentSubmission.data.parallelSurvey = (0, _Submission2.default)().setParallelSurvey(parallelSurvey);
